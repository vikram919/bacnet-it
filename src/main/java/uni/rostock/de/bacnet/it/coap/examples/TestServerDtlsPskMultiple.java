...
public class TestServerDtlsPskMultiple {
	...
	public static void main(String[] args) {
		...
		TestServerDtlsPskMultiple testServer = new TestServerDtlsPskMultiple();
		/**
	...
	public void start() {
		...
		channelConfigure.registerChannelListener(new ChannelListener(new BACnetEID(AUTH_ID)) {
			...
			public void onIndication(T_UnitDataIndication arg0, Object arg1) {
				...
				if (receivedRequest instanceof ConfirmedRequest && ((ConfirmedRequest) receivedRequest)
					...
					// receives the unconfirmed request
				}
			}
