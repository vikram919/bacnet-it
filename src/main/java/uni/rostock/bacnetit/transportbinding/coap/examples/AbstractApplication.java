...
public abstract class AbstractApplication {
	...
	/**
	 * sendReadPropertyRequestUsingBACnet4j() sends a ReadRequestProperty to a given
	 * destination. To represent such a ReadPropertyRequest BACnet4J is used. Note
	 * that the TPDU constructor demands a byte array that represents the BACnet
	 * service. Feel free to provide the byte array without the usage of BACnet4J by
	 * using the sendBACnetMessage(byte[]) method.
	 * 
	 * @throws URISyntaxException
	 */
	public void sendReadPropertyRequest(URI destination, BACnetEID from, BACnetEID to)
			throws URISyntaxException {
	...
	/**
	 * sendBACnetMessage() sends a BACnet message represented as byte array to the
	 * given destination. Ensure the byte array represents a valid BACnet message.
	 * 
	 * @param bacnetMessage
	 * @throws URISyntaxException
	 */
